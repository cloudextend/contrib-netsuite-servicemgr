...
namespace SuiteTalk
{
    public partial class ContactSearchRow: ISearchRow, ISearchRow<ContactSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<ContactSearchRowBasic> 
            ISearchRow<ContactSearchRowBasic>.CreateBasic(Action<ContactSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<ContactSearchRowBasic> 
            ISearchRow<ContactSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
