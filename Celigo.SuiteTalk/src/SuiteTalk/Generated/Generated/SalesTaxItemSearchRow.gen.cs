...
namespace SuiteTalk
{
    public partial class SalesTaxItemSearchRow: ISearchRow, ISearchRow<SalesTaxItemSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<SalesTaxItemSearchRowBasic> 
            ISearchRow<SalesTaxItemSearchRowBasic>.CreateBasic(Action<SalesTaxItemSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<SalesTaxItemSearchRowBasic> 
            ISearchRow<SalesTaxItemSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
