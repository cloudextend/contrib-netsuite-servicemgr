...
namespace SuiteTalk
{
    public partial class VendorCategorySearchRow: ISearchRow, ISearchRow<VendorCategorySearchRowBasic>
    {
        ...
        ISearchRow<VendorCategorySearchRowBasic> 
            ISearchRow<VendorCategorySearchRowBasic>.CreateBasic(Action<VendorCategorySearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<VendorCategorySearchRowBasic> 
            ISearchRow<VendorCategorySearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
