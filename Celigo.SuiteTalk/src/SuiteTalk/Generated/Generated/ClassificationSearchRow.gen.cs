...
namespace SuiteTalk
{
    public partial class ClassificationSearchRow: ISearchRow, ISearchRow<ClassificationSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<ClassificationSearchRowBasic> 
            ISearchRow<ClassificationSearchRowBasic>.CreateBasic(Action<ClassificationSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<ClassificationSearchRowBasic> 
            ISearchRow<ClassificationSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
