...
namespace SuiteTalk
{
    public partial class NexusSearchRow: ISearchRow, ISearchRow<NexusSearchRowBasic>
    {
        ...
        ISearchRow<NexusSearchRowBasic> 
            ISearchRow<NexusSearchRowBasic>.CreateBasic(Action<NexusSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<NexusSearchRowBasic> 
            ISearchRow<NexusSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
