...
namespace SuiteTalk
{
    public partial class ContactCategorySearchRow: ISearchRow, ISearchRow<ContactCategorySearchRowBasic>
    {
        ...
        ISearchRow<ContactCategorySearchRowBasic> 
            ISearchRow<ContactCategorySearchRowBasic>.CreateBasic(Action<ContactCategorySearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<ContactCategorySearchRowBasic> 
            ISearchRow<ContactCategorySearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
