...
namespace SuiteTalk
{
    public partial class BinSearchRow: ISearchRow, ISearchRow<BinSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<BinSearchRowBasic> 
            ISearchRow<BinSearchRowBasic>.CreateBasic(Action<BinSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<BinSearchRowBasic> 
            ISearchRow<BinSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
