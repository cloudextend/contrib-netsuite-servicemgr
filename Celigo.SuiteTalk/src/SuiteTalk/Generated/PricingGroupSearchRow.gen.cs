...
namespace SuiteTalk
{
    public partial class PricingGroupSearchRow: ISearchRow, ISearchRow<PricingGroupSearchRowBasic>
    {
        ...
        ISearchRow<PricingGroupSearchRowBasic> 
            ISearchRow<PricingGroupSearchRowBasic>.CreateBasic(Action<PricingGroupSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<PricingGroupSearchRowBasic> 
            ISearchRow<PricingGroupSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
