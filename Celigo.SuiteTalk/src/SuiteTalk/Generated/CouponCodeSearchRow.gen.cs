...
namespace SuiteTalk
{
    public partial class CouponCodeSearchRow: ISearchRow, ISearchRow<CouponCodeSearchRowBasic>
    {
        ...
        ISearchRow<CouponCodeSearchRowBasic> 
            ISearchRow<CouponCodeSearchRowBasic>.CreateBasic(Action<CouponCodeSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<CouponCodeSearchRowBasic> 
            ISearchRow<CouponCodeSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
