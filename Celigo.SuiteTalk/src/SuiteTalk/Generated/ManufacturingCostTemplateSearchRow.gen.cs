...
namespace SuiteTalk
{
    public partial class ManufacturingCostTemplateSearchRow: ISearchRow, ISearchRow<ManufacturingCostTemplateSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<ManufacturingCostTemplateSearchRowBasic> 
            ISearchRow<ManufacturingCostTemplateSearchRowBasic>.CreateBasic(Action<ManufacturingCostTemplateSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<ManufacturingCostTemplateSearchRowBasic> 
            ISearchRow<ManufacturingCostTemplateSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
