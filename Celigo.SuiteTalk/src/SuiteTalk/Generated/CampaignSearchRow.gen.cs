...
namespace SuiteTalk
{
    public partial class CampaignSearchRow: ISearchRow, ISearchRow<CampaignSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<CampaignSearchRowBasic> 
            ISearchRow<CampaignSearchRowBasic>.CreateBasic(Action<CampaignSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<CampaignSearchRowBasic> 
            ISearchRow<CampaignSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
