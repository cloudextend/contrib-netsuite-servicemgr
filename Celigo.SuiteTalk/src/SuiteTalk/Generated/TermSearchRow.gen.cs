...
namespace SuiteTalk
{
    public partial class TermSearchRow: ISearchRow, ISearchRow<TermSearchRowBasic>
    {
        ...
        ISearchRow<TermSearchRowBasic> 
            ISearchRow<TermSearchRowBasic>.CreateBasic(Action<TermSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<TermSearchRowBasic> 
            ISearchRow<TermSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
