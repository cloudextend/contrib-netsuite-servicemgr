...
namespace SuiteTalk
{
    public partial class JobSearchRow: ISearchRow, ISearchRow<JobSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<JobSearchRowBasic> 
            ISearchRow<JobSearchRowBasic>.CreateBasic(Action<JobSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<JobSearchRowBasic> 
            ISearchRow<JobSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
