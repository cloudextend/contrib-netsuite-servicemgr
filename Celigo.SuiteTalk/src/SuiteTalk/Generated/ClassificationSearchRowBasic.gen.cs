...
namespace SuiteTalk
{
    partial class ClassificationSearchRowBasic
    {
        ...
        class ColumnFactory:  ColumnFactory<ClassificationSearchRowBasic>
        {
            protected override Dictionary<string, Action<ClassificationSearchRowBasic>> InitializeColumnBuilders()
            {
                return new Dictionary<string, Action<ClassificationSearchRowBasic>> {
