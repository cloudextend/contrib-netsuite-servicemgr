...
namespace SuiteTalk
{
    public partial class InventoryNumberSearchRow: ISearchRow, ISearchRow<InventoryNumberSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<InventoryNumberSearchRowBasic> 
            ISearchRow<InventoryNumberSearchRowBasic>.CreateBasic(Action<InventoryNumberSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<InventoryNumberSearchRowBasic> 
            ISearchRow<InventoryNumberSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
