...
namespace SuiteTalk
{
    public partial class EntityGroupSearchRow: ISearchRow, ISearchRow<EntityGroupSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<EntityGroupSearchRowBasic> 
            ISearchRow<EntityGroupSearchRowBasic>.CreateBasic(Action<EntityGroupSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<EntityGroupSearchRowBasic> 
            ISearchRow<EntityGroupSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
