            ...
            protected override Dictionary<string, Action<EmployeeSearchRowBasic>> InitializeColumnBuilders()
            {
                return new Dictionary<string, Action<EmployeeSearchRowBasic>> {
                   ...
                   // which is not a SearchColumnField type. 
                    ...
                    { "bonusTarget", r => r.@bonusTarget = new [] { new SearchColumnDoubleField { customLabel = "bonusTarget" } } },
                    { "bonusTargetComment", r => r.@bonusTargetComment = new [] { new SearchColumnStringField { customLabel = "bonusTargetComment" } } },
                    { "bonusTargetPayFrequency", r => r.@bonusTargetPayFrequency = new [] { new SearchColumnEnumSelectField { customLabel = "bonusTargetPayFrequency" } } },
                    { "bonusTargetType", r => r.@bonusTargetType = new [] { new SearchColumnEnumSelectField { customLabel = "bonusTargetType" } } },
                    ...
                    { "corporateCardProfile", r => r.@corporateCardProfile = new [] { new SearchColumnSelectField { customLabel = "corporateCardProfile" } } },
                    ...
                    { "embossedName", r => r.@embossedName = new [] { new SearchColumnStringField { customLabel = "embossedName" } } },
                    ...
                    { "expiration", r => r.@expiration = new [] { new SearchColumnDateField { customLabel = "expiration" } } },
                    ...
                    { "targetUtilization", r => r.@targetUtilization = new [] { new SearchColumnDoubleField { customLabel = "targetUtilization" } } },
