...
namespace SuiteTalk
{
    public partial class AccountSearchRow: ISearchRow, ISearchRow<AccountSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<AccountSearchRowBasic> 
            ISearchRow<AccountSearchRowBasic>.CreateBasic(Action<AccountSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<AccountSearchRowBasic> 
            ISearchRow<AccountSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
