...
namespace SuiteTalk
{
    public partial class ExpenseCategorySearchRow: ISearchRow, ISearchRow<ExpenseCategorySearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<ExpenseCategorySearchRowBasic> 
            ISearchRow<ExpenseCategorySearchRowBasic>.CreateBasic(Action<ExpenseCategorySearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<ExpenseCategorySearchRowBasic> 
            ISearchRow<ExpenseCategorySearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
