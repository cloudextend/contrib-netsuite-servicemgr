...
namespace SuiteTalk
{
    public partial class BomRevisionSearchRow: ISearchRow, ISearchRow<BomRevisionSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<BomRevisionSearchRowBasic> 
            ISearchRow<BomRevisionSearchRowBasic>.CreateBasic(Action<BomRevisionSearchRowBasic> initializer) => this.CreateBasic(initializer);

        public BomRevisionSearchRow CreateBasic(Action<BomRevisionSearchRowBasic> initializer)
        {
        ...
        ISearchRow<BomRevisionSearchRowBasic> 
            ISearchRow<BomRevisionSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);

        public BomRevisionSearchRow CreateJoin<J>(string joinName, Action<J> initializer) where J: SearchRowBasic
        {
      ...
      //      yield return this.billOfMaterialsJoin;
      //      yield return this.componentJoin;
      //      yield return this.transactionJoin;
        ...
        private static SearchRowBasic GetOrCreateJoin(BomRevisionSearchRow target, string joinName, bool createIfNull = false)
        {
            ...
            switch (joinName)
            {
                case "basic":
                    result = target.basic;
                    creator = () => target.basic = new BomRevisionSearchRowBasic();
                    break;
