...
namespace SuiteTalk
{
    public partial class ItemSearchRow: ISearchRow, ISearchRow<ItemSearchRowBasic>, ISupportsCustomSearchJoin
    {
        ...
        ISearchRow<ItemSearchRowBasic> 
            ISearchRow<ItemSearchRowBasic>.CreateBasic(Action<ItemSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchRow<ItemSearchRowBasic> 
            ISearchRow<ItemSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
