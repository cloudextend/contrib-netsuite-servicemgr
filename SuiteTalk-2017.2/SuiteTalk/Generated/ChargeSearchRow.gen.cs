...
namespace SuiteTalk
{
    public partial class ChargeSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<ChargeSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<ChargeSearchRowBasic> 
            ISearchAdvancedRow<ChargeSearchRowBasic>.CreateBasic(Action<ChargeSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<ChargeSearchRowBasic> 
            ISearchAdvancedRow<ChargeSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
