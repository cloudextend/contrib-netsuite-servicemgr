...
namespace SuiteTalk
{
    public partial class TimeBillSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<TimeBillSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<TimeBillSearchRowBasic> 
            ISearchAdvancedRow<TimeBillSearchRowBasic>.CreateBasic(Action<TimeBillSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<TimeBillSearchRowBasic> 
            ISearchAdvancedRow<TimeBillSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
