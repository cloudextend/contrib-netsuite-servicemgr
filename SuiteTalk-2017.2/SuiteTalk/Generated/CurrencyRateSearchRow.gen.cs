...
namespace SuiteTalk
{
    public partial class CurrencyRateSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<CurrencyRateSearchRowBasic>
    {
        ...
        ISearchAdvancedRow<CurrencyRateSearchRowBasic> 
            ISearchAdvancedRow<CurrencyRateSearchRowBasic>.CreateBasic(Action<CurrencyRateSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<CurrencyRateSearchRowBasic> 
            ISearchAdvancedRow<CurrencyRateSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
