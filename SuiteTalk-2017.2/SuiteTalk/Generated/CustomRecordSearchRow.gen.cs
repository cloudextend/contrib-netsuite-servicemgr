...
namespace SuiteTalk
{
    public partial class CustomRecordSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<CustomRecordSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<CustomRecordSearchRowBasic> 
            ISearchAdvancedRow<CustomRecordSearchRowBasic>.CreateBasic(Action<CustomRecordSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<CustomRecordSearchRowBasic> 
            ISearchAdvancedRow<CustomRecordSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
