...
namespace SuiteTalk
{
    partial class OtherNameCategorySearchRowBasic
    {
        ...
        class ColumnFactory:  ColumnFactory<OtherNameCategorySearchRowBasic>
        {
            protected override Dictionary<string, Action<OtherNameCategorySearchRowBasic>> InitializeColumnBuilders()
            {
                return new Dictionary<string, Action<OtherNameCategorySearchRowBasic>> {
