...
namespace SuiteTalk
{
    public partial class TransactionSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<TransactionSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<TransactionSearchRowBasic> 
            ISearchAdvancedRow<TransactionSearchRowBasic>.CreateBasic(Action<TransactionSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<TransactionSearchRowBasic> 
            ISearchAdvancedRow<TransactionSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
