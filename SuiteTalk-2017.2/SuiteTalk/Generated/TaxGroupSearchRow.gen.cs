...
namespace SuiteTalk
{
    public partial class TaxGroupSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<TaxGroupSearchRowBasic>
    {
        ...
        ISearchAdvancedRow<TaxGroupSearchRowBasic> 
            ISearchAdvancedRow<TaxGroupSearchRowBasic>.CreateBasic(Action<TaxGroupSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<TaxGroupSearchRowBasic> 
            ISearchAdvancedRow<TaxGroupSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
