...
namespace SuiteTalk
{
    partial class TopicSearchRowBasic
    {
        ...
        class ColumnFactory:  ColumnFactory<TopicSearchRowBasic>
        {
            protected override Dictionary<string, Action<TopicSearchRowBasic>> InitializeColumnBuilders()
            {
                return new Dictionary<string, Action<TopicSearchRowBasic>> {
