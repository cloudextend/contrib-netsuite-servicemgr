...
namespace SuiteTalk
{
    public partial class FolderSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<FolderSearchRowBasic>
    {
        ...
        ISearchAdvancedRow<FolderSearchRowBasic> 
            ISearchAdvancedRow<FolderSearchRowBasic>.CreateBasic(Action<FolderSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<FolderSearchRowBasic> 
            ISearchAdvancedRow<FolderSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
