...
namespace SuiteTalk
{
    public partial class WinLossReasonSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<WinLossReasonSearchRowBasic>
    {
        ...
        ISearchAdvancedRow<WinLossReasonSearchRowBasic> 
            ISearchAdvancedRow<WinLossReasonSearchRowBasic>.CreateBasic(Action<WinLossReasonSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<WinLossReasonSearchRowBasic> 
            ISearchAdvancedRow<WinLossReasonSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
