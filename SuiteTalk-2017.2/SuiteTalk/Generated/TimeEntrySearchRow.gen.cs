...
namespace SuiteTalk
{
    public partial class TimeEntrySearchRow: ISearchAdvancedRow, ISearchAdvancedRow<TimeEntrySearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<TimeEntrySearchRowBasic> 
            ISearchAdvancedRow<TimeEntrySearchRowBasic>.CreateBasic(Action<TimeEntrySearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<TimeEntrySearchRowBasic> 
            ISearchAdvancedRow<TimeEntrySearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
