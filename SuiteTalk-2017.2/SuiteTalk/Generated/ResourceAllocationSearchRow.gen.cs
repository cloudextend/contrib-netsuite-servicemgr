...
namespace SuiteTalk
{
    public partial class ResourceAllocationSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<ResourceAllocationSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<ResourceAllocationSearchRowBasic> 
            ISearchAdvancedRow<ResourceAllocationSearchRowBasic>.CreateBasic(Action<ResourceAllocationSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<ResourceAllocationSearchRowBasic> 
            ISearchAdvancedRow<ResourceAllocationSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
