...
namespace SuiteTalk
{
    partial class OriginatingLeadSearchRowBasic
    {
        ...
        class ColumnFactory:  ColumnFactory<OriginatingLeadSearchRowBasic>
        {
            protected override Dictionary<string, Action<OriginatingLeadSearchRowBasic>> InitializeColumnBuilders()
            {
                return new Dictionary<string, Action<OriginatingLeadSearchRowBasic>> {
                    ...
                    { "stage", r => r.@stage = new [] { new SearchColumnStringField { customLabel = "stage" } } },
