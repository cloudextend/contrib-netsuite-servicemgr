...
namespace SuiteTalk
{
    partial class MseSubsidiarySearchRowBasic
    {
        ...
        class ColumnFactory:  ColumnFactory<MseSubsidiarySearchRowBasic>
        {
            protected override Dictionary<string, Action<MseSubsidiarySearchRowBasic>> InitializeColumnBuilders()
            {
                return new Dictionary<string, Action<MseSubsidiarySearchRowBasic>> {
                    ...
                    { "primary", r => r.@primary = new [] { new SearchColumnBooleanField { customLabel = "primary" } } },
