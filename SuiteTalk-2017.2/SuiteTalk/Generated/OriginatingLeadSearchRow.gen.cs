...
namespace SuiteTalk
{
    public partial class OriginatingLeadSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<OriginatingLeadSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<OriginatingLeadSearchRowBasic> 
            ISearchAdvancedRow<OriginatingLeadSearchRowBasic>.CreateBasic(Action<OriginatingLeadSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<OriginatingLeadSearchRowBasic> 
            ISearchAdvancedRow<OriginatingLeadSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
