...
namespace SuiteTalk
{
    public partial class OtherNameCategorySearchRow: ISearchAdvancedRow, ISearchAdvancedRow<OtherNameCategorySearchRowBasic>
    {
        ...
        ISearchAdvancedRow<OtherNameCategorySearchRowBasic> 
            ISearchAdvancedRow<OtherNameCategorySearchRowBasic>.CreateBasic(Action<OtherNameCategorySearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<OtherNameCategorySearchRowBasic> 
            ISearchAdvancedRow<OtherNameCategorySearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
