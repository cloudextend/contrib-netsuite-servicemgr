...
namespace SuiteTalk
{
    public partial class PartnerSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<PartnerSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<PartnerSearchRowBasic> 
            ISearchAdvancedRow<PartnerSearchRowBasic>.CreateBasic(Action<PartnerSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<PartnerSearchRowBasic> 
            ISearchAdvancedRow<PartnerSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
