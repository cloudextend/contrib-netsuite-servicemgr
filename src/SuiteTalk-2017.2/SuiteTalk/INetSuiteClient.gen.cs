namespace SuiteTalk
{
    ...
    {
      public async System.Threading.Tasks.Task<SessionResponse> loginAsync()
      {
      ...
      public async System.Threading.Tasks.Task<SessionResponse> ssoLoginAsync(SsoPassport ssoPassport)
      {
      ...
      public async System.Threading.Tasks.Task<SessionResponse> mapSsoAsync(SsoCredentials ssoCredentials)
      {
      ...
      public async System.Threading.Tasks.Task<SessionResponse> logoutAsync()
      {
      ...
      public async System.Threading.Tasks.Task<SearchResult> searchAsync(SearchRecord searchRecord)
      {
      ...
      public async System.Threading.Tasks.Task<SearchResult> searchMoreAsync(int pageIndex)
      {
      ...
      public async System.Threading.Tasks.Task<SearchResult> searchMoreWithIdAsync(string searchId,int pageIndex)
      {
      ...
      public async System.Threading.Tasks.Task<SearchResult> searchNextAsync()
      {
      ...
      public async System.Threading.Tasks.Task<AsyncStatusResult> asyncSearchAsync(SearchRecord searchRecord)
      {
