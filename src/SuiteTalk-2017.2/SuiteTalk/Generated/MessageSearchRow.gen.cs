...
namespace SuiteTalk
{
    public partial class MessageSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<MessageSearchRowBasic>
    {
        ...
        ISearchAdvancedRow<MessageSearchRowBasic> 
            ISearchAdvancedRow<MessageSearchRowBasic>.CreateBasic(Action<MessageSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<MessageSearchRowBasic> 
            ISearchAdvancedRow<MessageSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
