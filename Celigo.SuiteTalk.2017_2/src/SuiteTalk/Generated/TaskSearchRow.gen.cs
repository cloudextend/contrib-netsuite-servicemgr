...
namespace SuiteTalk
{
    public partial class TaskSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<TaskSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<TaskSearchRowBasic> 
            ISearchAdvancedRow<TaskSearchRowBasic>.CreateBasic(Action<TaskSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<TaskSearchRowBasic> 
            ISearchAdvancedRow<TaskSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
