...
namespace SuiteTalk
{
    public partial class ManufacturingOperationTaskSearchRow: ISearchAdvancedRow, ISearchAdvancedRow<ManufacturingOperationTaskSearchRowBasic>, SupportsCustomSearchJoin
    {
        ...
        ISearchAdvancedRow<ManufacturingOperationTaskSearchRowBasic> 
            ISearchAdvancedRow<ManufacturingOperationTaskSearchRowBasic>.CreateBasic(Action<ManufacturingOperationTaskSearchRowBasic> initializer) => this.CreateBasic(initializer);
        ...
        ISearchAdvancedRow<ManufacturingOperationTaskSearchRowBasic> 
            ISearchAdvancedRow<ManufacturingOperationTaskSearchRowBasic>.CreateJoin<J>(string joinName, Action<J> initializer) => this.CreateJoin(joinName, initializer);
